...
assertEquals(subject.getPayload().getCurrentItemReference().getContent().getId(), "1021012f-12bb-4938-9723-067a4338b6d0");assertEquals(subject.getPayload().getCurrentItemReference().getContent().getMetadataType(), "TRACK");assertTrue((boolean)subject.getPayload().getIsUserInitiated());
