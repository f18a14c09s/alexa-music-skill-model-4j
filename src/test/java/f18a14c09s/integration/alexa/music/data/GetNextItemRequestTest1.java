 ...
 */
public class GetNextItemRequestTest1 {
    /**
    ...
    void testDeserialization() throws IOException {
        ...
        assertFalse((boolean) subject.getPayload().getIsUserInitiated());
