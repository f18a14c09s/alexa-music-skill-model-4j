...
import static f18a14c09s.integration.alexa.music.data.ControlName.SHUFFLE;
...
import static f18a14c09s.integration.alexa.music.data.PlaybackMethod.Type.ALEXA_AUDIO_PLAYER_QUEUE;
...
public class InitiateResponseTest {
    ...
    void testDeserialization() throws IOException {
        ...
        assertTrue(subject.getPayload().getPlaybackMethod() instanceof AudioPlayerQueue);
        AudioPlayerQueue audioPlayerQueue = (AudioPlayerQueue) subject.getPayload().getPlaybackMethod();
        assertEquals(audioPlayerQueue.getId(), "76f325d5-a648-4e8f-87ad-6e53cf99e4c7");
        assertEquals(audioPlayerQueue.getControls().get(0).getType(), TOGGLE);
        assertEquals(audioPlayerQueue.getControls().get(0).getName(), SHUFFLE);
        assertTrue((boolean) audioPlayerQueue.getControls().get(0).getEnabled());
//        assertFalse((boolean) audioPlayerQueue.getControls().get(0).getSelected());
        assertEquals(audioPlayerQueue.getControls().get(1).getType(), TOGGLE);
        assertEquals(audioPlayerQueue.getControls().get(1).getName(), LOOP);
        assertTrue((boolean) audioPlayerQueue.getControls().get(1).getEnabled());
//        assertFalse((boolean) audioPlayerQueue.getControls().get(1).getSelected());
