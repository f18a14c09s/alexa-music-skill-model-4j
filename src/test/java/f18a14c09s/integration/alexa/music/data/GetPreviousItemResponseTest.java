...
public class GetPreviousItemResponseTest {
    ...
    void testDeserialization() throws IOException {
        ...
        GetPreviousItemResponse subject = (GetPreviousItemResponse) obj;
        ...
        assertEquals(subject.getPayload().getItem().getStream().getValidUntil(), "2018-11-10T19:11:35Z");
