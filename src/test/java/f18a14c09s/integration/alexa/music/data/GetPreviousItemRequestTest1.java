...
assertEquals(subject.getPayload().getCurrentItemReference().getId(), "533718fe-b22d-4f64-8b1c-49ffdb85f619");assertEquals(subject.getPayload().getCurrentItemReference().getQueueId(), "76f325d5-a648-4e8f-87ad-6e53cf99e4c7");
assertEquals(subject.getPayload().getCurrentItemReference().getContent().getId(), "1021012f-12bb-4938-9723-067a4338b6d0");assertEquals(subject.getPayload().getCurrentItemReference().getContent().getMetadataType(), "TRACK");
assertEquals(subject.getHeader().getMessageId(), "2cae4d53-6bc1-4f8f-aa98-7dd2727ca84b");assertEquals(subject.getHeader().getNamespace(), "Alexa.Audio.PlayQueue");assertEquals(subject.getHeader().getName(), "GetPreviousItem");assertEquals(subject.getHeader().getPayloadVersion(), "1.0");
}
}