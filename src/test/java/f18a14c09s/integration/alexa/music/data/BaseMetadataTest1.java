...
import static f18a14c09s.integration.alexa.music.data.MediaMetadata.Type.ARTIST;
...
public class BaseMetadataTest1 {
    ...
    void testDeserialization() throws IOException {
        ...
        assertEquals(subject.getName().getSpeech().getText(), "nirvana");
        assertEquals(subject.getName().getDisplay(), "Nirvana");
        assertEquals(subject.getType(), ARTIST);
    }
}