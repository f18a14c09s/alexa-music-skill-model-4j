...
public class PlaybackMethodTest1 {
    ...
    void testDeserialization() throws IOException {
        ...
        PlaybackMethod obj = jsonMapper.readValue(TEST_CASE, PlaybackMethod.class);
        AudioPlayerQueue subject = assertInstanceOfAndCast(obj, AudioPlayerQueue.class);
        ToggleQueueControl toggleQueueControl =
                assertInstanceOfAndCast(subject.getControls().get(0), ToggleQueueControl.class);
        ...
        toggleQueueControl = assertInstanceOfAndCast(subject.getControls().get(1), ToggleQueueControl.class);
        assertEquals(toggleQueueControl.getType(), TOGGLE);
        ...
        assertEquals(DateUtil.formatAsIso8601UtcSeconds(subject.getFirstItem().getStream().getValidUntil()),
