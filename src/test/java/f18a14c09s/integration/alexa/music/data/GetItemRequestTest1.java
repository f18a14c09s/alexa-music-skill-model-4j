...
public class GetItemRequestTest1 {
    ...
    void testDeserialization() throws IOException {
        ...
        assertTrue(subject.getPayload().getTargetItemReference().getValue() instanceof ItemReference);
        ItemReference itemReference = (ItemReference) subject.getPayload().getTargetItemReference().getValue();
        assertEquals(itemReference.getId(), "e73befbe-8c27-4e4b-ab0c-9865ce8516f0");
        assertEquals(itemReference.getQueueId(), "76f325d5-a648-4e8f-87ad-6e53cf99e4c7");
        assertEquals(itemReference.getContentId(), "1021012f-12bb-4938-9723-067a4338b6d0");
