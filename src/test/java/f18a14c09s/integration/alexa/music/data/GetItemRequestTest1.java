...
public class GetItemRequestTest1 {
    ...
    void testDeserialization() throws IOException {
        ...
        assertEquals(subject.getPayload().getTargetItemReference().getValue().getId(), "e73befbe-8c27-4e4b-ab0c-9865ce8516f0");
        assertEquals(subject.getPayload().getTargetItemReference().getValue().getQueueId(), "76f325d5-a648-4e8f-87ad-6e53cf99e4c7");
        assertEquals(subject.getPayload().getTargetItemReference().getValue().getContentId(), "1021012f-12bb-4938-9723-067a4338b6d0");
