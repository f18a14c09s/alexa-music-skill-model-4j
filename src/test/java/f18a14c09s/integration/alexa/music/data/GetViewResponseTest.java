...
public class GetViewResponseTest {
    ...
    void testDeserialization() throws IOException {
        ...
        assertEquals(subject.getPayload().getQueueControls().get(0).getType(), "TOGGLE");
        assertEquals(subject.getPayload().getQueueControls().get(0).getName(), "SHUFFLE");
        assertTrue((boolean) subject.getPayload().getQueueControls().get(0).getEnabled());
        assertFalse((boolean) subject.getPayload().getQueueControls().get(0).getSelected());
        assertEquals(subject.getPayload().getQueueControls().get(1).getType(), "TOGGLE");
        assertEquals(subject.getPayload().getQueueControls().get(1).getName(), "LOOP");
        assertTrue((boolean) subject.getPayload().getQueueControls().get(1).getEnabled());
        assertFalse((boolean) subject.getPayload().getQueueControls().get(1).getSelected());
